...
public class CalTest_eja {
	...
	public static Collection<Object[]> parameters() {	// Base {1, 1, 12, 31, 1, 364}
		return Arrays.asList (new Object [][] { /* 0 */ {1, 1, 1, 31, 1, 30},     /* 1 */{1, 1, 12, 31, 1, 364},     /* 2 */ {1, 1, 2, 31, 1, 31}, 
												/* 3 */ {1, 1, 4, 31, 1, 90},     /* 4 */{2, 1, 12, 31, 1, 333},     /* 5 */{4, 1, 12, 31, 1, 274},      
												/* 6 */ {1, 31, 12, 31, 1, 334},  /* 7 */ {1, 32, 12, 31, 1, 364},   /* 8 */{1, 1, 12, 1, 1, 334}, 
												/* 9 */ {1, 1, 12, 0, 1, 334},    /* 10 */{1, 1, 12, 31, 2016, 365}, /* 11 */{1, 1, 12 , 31, 2017, 364} 
											  }); 
	}
